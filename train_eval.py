...
if __name__ == "__main__":
    ...
    parser.add_argument("--epoch", default=10, type=int, help="The epoch to be tested")
    parser.add_argument("--gpu", default='0', type=str, help="choose which DEVICE U want to use")
